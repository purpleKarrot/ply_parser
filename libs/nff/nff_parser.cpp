...
bool nff::nff_parser::parse(std::istream& istream)
{
  ...
  std::size_t number_of_v_entities = 0, number_of_b_entities = 0, number_of_l_entities = 0, number_of_f_entities = 0, number_of_c_entities = 0, number_of_s_entities = 0, number_of_p_entities = 0, number_of_pp_entities = 0;
